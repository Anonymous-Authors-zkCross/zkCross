  ...
  <node concept="1KMFyu" id="18zTa4d4FrA">
    ...
    <node concept="2YIFZL" id="18zTa4d4Fs2" role="jymVt">
      ...
      <node concept="3clFbS" id="18zTa4d4Fs5" role="3clF47">
        ...
        <node concept="3clFbF" id="2jRoAjB4vc2" role="3cqZAp">
          <node concept="37vLTI" id="2jRoAjB4vc3" role="3clFbG">
            <node concept="Xl_RD" id="2jRoAjB4vc4" role="37vLTx">
              <property role="Xl_RC" value="/home/u0/zksync/src/xjsnark_output/circuit" />
            </node>
            <node concept="10M0yZ" id="2jRoAjB4vc5" role="37vLTJ">
              <ref role="3cqZAo" to="85wc:~Config.outputFilesPath" resolve="outputFilesPath" />
              <ref role="1PxDUh" to="85wc:~Config" resolve="Config" />
            </node>
          </node>
        </node>
        <node concept="3clFbH" id="eMa3f$KVjR" role="3cqZAp" />
      </node>
