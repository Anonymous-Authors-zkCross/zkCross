...
string FunctionType::richIdentifier() const
{
	...
	/////gyh
	case Kind::veriGroupsign: id += "veriGroupsign"; break;
	case Kind::verhfProof: id += "verhfProof"; break;
	/////
...
bool FunctionType::isBareCall() const
{
	...
	case Kind::VeriTV:
	/////gyh
	case Kind::veriGroupsign:
	case Kind::verhfProof:		
	/////
		return true;
	default:
		return false;
...
bool FunctionType::isPure() const
{
	...
	return
		...
		m_kind == Kind::VeriTV ||
		/////gyh
		m_kind == Kind::veriGroupsign ||
		m_kind == Kind::verhfProof ||
		////
		m_kind == Kind::AddMod ||
		m_kind == Kind::MulMod ||
